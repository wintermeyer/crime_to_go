defmodule CrimeToGoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CrimeToGoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CrimeToGoWeb.Gettext, "errors", msg, opts)
    end
  end
